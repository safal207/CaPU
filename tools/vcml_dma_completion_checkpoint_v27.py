...
DOMAIN=b'capu.vcml.dma-completion-uncertainty.v0.27\0'
FIELDS=(
 'base_v26_digest','runtime_ready','command_pending','live_command_id','live_execution_epoch','live_effect_id',
