...
const steps = [
  ...
  npmStep('runtime HTTP error taxonomy validation', 'validate:runtime-http-error-taxonomy', 'The runtime HTTP error taxonomy is synchronized with manifest route IDs, HTTP status codes, boundaries, and response fixtures.'),
