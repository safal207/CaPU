...
- Phase 2 roadmap: [docs/hardware/CMC_PHASE_2_ROADMAP.md](docs/hardware/CMC_PHASE_2_ROADMAP.md)
- Invariants map: [docs/hardware/CMC_INVARIANTS.md](docs/hardware/CMC_INVARIANTS.md)
